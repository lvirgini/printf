...
/*   Updated: 2020/02/22 19:18:22 by lvirgini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		convert_unicode(wchar_t arg, int nb_oct)
{
	...
	{
		octet[0] = (((unsigned)arg >> 6) & WC2) | MB2;
		octet[1] = ((unsigned)arg & WC1) | MB1;
	}
	else if (nb_oct == 3)
	{
		octet[0] = (((unsigned)arg >> 12) & WC3) | MB3;
		octet[1] = (((unsigned)arg >> 6) & WC1) | MB1;
		octet[2] = ((unsigned)arg  & WC1) | MB1;
	}
	else
	{
		octet[0] = (((unsigned)arg >> 18) & WC4) | MB4;
		octet[1] = (((unsigned)arg >> 12) & WC1) | MB1;
		octet[2] = (((unsigned)arg >> 6) & WC1) | MB1;
		octet[3] = ((unsigned)arg & WC1) | MB1;
	}
